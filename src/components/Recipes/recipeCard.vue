<template>
    ...
    <div class="recipeCard">
        ...
        <div class="recipeName cardSection">
			<h6 class="noselect">
                Recipe
                <!-- <svg @dblclick="editRecipe(recipe)" class="editB" height="25pt" viewBox="-15 -15 455 450" preserveAspectRatio="xMidYMin meet" width="25pt" stroke="black"  stroke-width="25" xmlns="http://www.w3.org/2000/svg">
